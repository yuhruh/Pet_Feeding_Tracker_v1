class PetTracker < ApplicationRecord
  ...
  validates :wet_left_amount, numericality: true, comparison: { less_than: :wet_amount }
  validates :dry_amount, numericality: true
  validates :dry_left_amount, numericality: true, comparison: { less_than: :dry_amount }
end
